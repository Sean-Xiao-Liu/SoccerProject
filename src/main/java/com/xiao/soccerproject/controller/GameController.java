...
public class GameController {
    ...
    //save game by id//
    @RequestMapping(value = "/{homeTeamId}/{awayTeamId}", method = RequestMethod.POST,consumes = {MediaType.APPLICATION_JSON_VALUE})
    ...
    //update home goals//
    @RequestMapping(value = "/{gameId}/{homeGoals}", method = RequestMethod.PUT, produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    //delete by id//
    @RequestMapping(value ="/{gameId}", method = RequestMethod.DELETE, produces = {MediaType.APPLICATION_JSON_VALUE})
